        ...
        <div className="bg-white p-3 rounded w-25">
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-3">
                    ...
                    <input type="password" placeholder="Enter Paasword" autoComplete="off" name="password" className="form-control rounded-0" onChange={(e)=> setPassword(e.target.value)}/>

                 </div>
                 <button type="Login" className="btn btn-success w-100 rounded-0">Login</button>
                 </form>
